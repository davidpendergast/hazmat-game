...
DOOR_OPENING        = create("door_opening", [R(16 + 16 * i, 96, 16, 32) for i in range(0, 5)], tpf=5)
...
PLAYER_RUN          = create("player_run", [R(400 + 32 * i, 32, 32, 32) for i in range(0, 6)], tpf=3)
...
PLAYER_CROUCH_WALK  = create("player_crouch_walk", [R(208 + i * 16, 64, 16, 32) for i in range(0, 6)], tpf=3)
